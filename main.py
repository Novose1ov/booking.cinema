...
""")
    ...
    if l == 'admin' and p == 'admin':
        ...
        print('\033[0m\033[5m[ПОДСКАЗКА]: логин должен начинаться с буквы и состоять не менее чем из 4 символов и не более чем из 20 символов')
        input('\033[0m\033[5m[ПОДСКАЗКА]: пароль не может совпадать с логином, должен состоять не менее чем из 6 символов и не более чем из 30 символов')

    elif (l in ERROR_log) or (l[0].isalpha() == False) or (len(l) < 4) or (len(l) > 20):
        print('\033[0m\033[31m[ERROR]: Неккоректный ввод')
        input('\033[0m\033[5m[ПОДСКАЗКА]: логин должен начинаться с буквы и состоять не менее чем из 4 символов и не более чем из 20 символов')
